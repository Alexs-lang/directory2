...
Public Class Agregar
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        Try
            ...
            Dim respuesta = New ProcAgregarFuncionario() With {.entidad = funcionario}.Ejecutar()
            Select Case respuesta.respuesta
                Case tipoRespuestaDelProceso.Completado
                    limpiarControles()
                    NotificacionToast("Los datos se guardaron correctamente", tipoNotificacion.Exitoso)
    ...
    Private Sub limpiarControles()
        ...
        txbCorreo.Text = ""
        txbCargo.Text = ""
        ddlTipoFuncionario.SelectedValue = "Seleccione un elemento de la lista"
        txbMapaOficina.Text = ""
        imgFoto.ImageUrl = "~/images/user.png"
        lblFoto.Text = "user.png"
        Session("listaTelefono") = Nothing
        lvsTelefonos.DataSource = CType(Session("listaTelefono"), List(Of Telefono))
