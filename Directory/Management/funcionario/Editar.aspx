<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Management/MasterPage.Master" CodeBehind="Editar.aspx.vb" Inherits="Directory.Editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-lg-6">
                    <h1 class="m-0 text-dark">Editar funcionario</h1>
                </div>
                <div class="col-lg-6">
